...
public class LatteParserCompilationUnitTest extends TestCase {
	/*
	 * Tries to parser the input string as a compilation unit
	 */
	...
	@Test
	public void testCompilationUnit06() throws Exception
	{
		try {
			testCompilationUnit("class test { int a; }asdjfhsdlkfjhdaslfk");
			assertFalse(1==1);
		} catch (RuntimeException e) {
			// TODO Auto-generated catch block
			System.out.println("expected exception thrown for an unparsable character at the end of the string for compilation unit: " + e.getMessage());
			assertTrue(1==1);
		}
	}
