...
*/
public class LatteTreeAdaptor extends CommonTreeAdaptor {

	/**
	 * Default constructor
	 */
	public LatteTreeAdaptor()
	{
		super();
	}
	...
	public Object create(Token payload)
	{
		//if (payload != null)
        //{
        //        System.out.println("Create " + LatteParser.tokenNames[payload.getType()] + ":  L" + payload.getLine() + ":C" + payload.getCharPositionInLine() + " " + payload.getText());
        //}
		return new LatteAST(payload);
	}
	 ...
	 */
	@Override
	public LatteAST dupNode(Object t)
	{
		if (t == null) return null;
		return (LatteAST) ((LatteAST)t).dupNode();
	}
	
// the below functions may be needed at some point and shoudl represent all the overridable functions for the class
/*
